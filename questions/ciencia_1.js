module.exports = [
  ...
  },
  {
    ...
    station: "Huesos",
    type: "multiple",
    context: "El cráneo es como un rompecabezas formado por varios huesos que se unen fuertemente para proteger nuestro cerebro.",
    prompt: "¿Cuáles de los siguientes son huesos que forman el cráneo?",
    options: [
      "Temporal, occipital, parietal, frontal y esfenoides.",
      "Fémur, tibia, peroné y húmero.",
      "Costillas, esternón, vértebras y clavícula."
    ],
    correctAnswer: "Temporal, occipital, parietal, frontal y esfenoides.",
    explain: "¡Muy bien! Estos huesos tienen nombres especiales y juntos forman la resistente bóveda de la cabeza."
  },
  {
    id: "sci_add_2",
    subject: "science",
    station: "Huesos",
    type: "multiple",
    context: "El cuerpo humano tiene huesos de muchos tamaños. ¡Hay uno que es tan pequeño como un granito de arroz y está súper escondido!",
    prompt: "¿Cuál es el hueso más pequeño del cuerpo humano y dónde se encuentra?",
    options: [
      "El estribo, que está dentro del oído.",
      "La falange, que está en la punta del dedo.",
      "La rótula, que está en la rodilla."
    ],
    correctAnswer: "El estribo, que está dentro del oído.",
    explain: "¡Correcto! El estribo está en el oído medio y ayuda a que podamos escuchar los sonidos. Mide solo unos 3 milímetros."
  },
  {
    id: "sci_add_3",
    subject: "science",
    station: "Cartílagos",
    type: "multiple",
    context: "Tócate la punta de la nariz o la parte de arriba de tu oreja. Verás que son flexibles y se pueden doblar un poco, no son tan duros como el hueso de tu brazo.",
    prompt: "¿Qué nombre recibe este material flexible del que están hechas la nariz y las orejas?",
    options: [
      "Cartílago",
      "Hueso blando",
      "Músculo elástico"
    ...
    explain: "El cartílago es un tejido muy resistente pero flexible. También está en nuestras articulaciones para que los huesos no raspen entre sí."
  },
  {
    id: "sci_add_4",
    subject: "science",
    station: "Huesos",
    type: "true_false",
    context: "Cuando nacemos somos muy pequeñitos, pero tenemos muchísimos huesos (cerca de 300).",
    prompt: "A medida que crecemos para ser adultos, algunos huesos se unen, por lo que un adulto termina teniendo menos huesos (solo 206).",
    options: ["Verdadero", "Falso"],
    correctAnswer: "Verdadero",
